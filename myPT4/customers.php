...
<head>
  ...
  <title>Apple Products Ordering System : Customers</title>
  <!-- Bootstrap -->
    ...
    <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
      ...
      <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
          <input name="phone" type="text" class="form-control" id="phone" placeholder="Customer Phone" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_customer_phonenum']; ?>" required>
        </div>
        </div>
        <div class="form-group">
    ...
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      ...
      try {
        ...
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
          $stmt = $conn->prepare("select * from tbl_customers_a176664_pt2 LIMIT $start_from, $per_page");
        $stmt->execute();
      ...
      <tr>
        ...
        <td>
            <a href="<?php if ($userlevel=="Admin"){ echo "customers.php?edit="; echo $readrow['fld_customer_id'];} ?>"class="btn btn-success btn-xs" role="button" onclick="<?php if ($userlevel=="Staff") echo "return confirm('Sorry, Only Admin Can Access This !');"?>" <?php if ($userlevel=="Staff") echo "disabled"?>> Edit</a>
          <a href="<?php if ($userlevel=="Admin"){ echo "customers.php?delete="; echo $readrow['fld_customer_id'];} ?>"class="btn btn-danger btn-xs" role="button" onclick="<?php if ($userlevel=="Staff") echo "return confirm('Sorry, Only Admin Can Access This !');"?>" <?php if ($userlevel=="Staff") echo "disabled"?>> Delete</a>
        </td>
      </tr>
      <?php
      }
